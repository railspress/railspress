...
// Connects to data-controller="ai-seo-analyzer"
export default class extends Controller {
  static targets = ["content"]

  connect() {
    console.log("AI SEO Analyzer block connected")
  }
  ...
  async generate(event) {
    ...
    try {
      ...
      if (data.success) {
        ...
        this.showSuccess("SEO generated successfully!")
      } else {
        this.showError(data.error || "Failed to generate SEO")
      }
    } catch (error) {
      console.error("Error generating SEO:", error)
      this.showError("An error occurred while generating SEO")
    } finally {
