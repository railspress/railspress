...
SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    connect_src: %w('self' ws: wss: http://localhost:3000 https://unpkg.com https://cdn.jsdelivr.net https://cdn.tailwindcss.com https://cdn.ckeditor.com https://cdnjs.cloudflare.com https://releases.transloadit.com https://images.unsplash.com https://images.pexels.com https://pixabay.com),
